...
![圆形分类数据](/projects/from-scratch-nn/assets/images/data_circle.png)
...
![ReLU 与 Sigmoid](/projects/from-scratch-nn/assets/images/relu.png)
![Sigmoid](/projects/from-scratch-nn/assets/images/sigmoid.png)

当很多个 ReLU 神经元叠在一起时，模型就不再只能画直线，而可以慢慢逼近更复杂的边界。

![隐藏层结构](/projects/from-scratch-nn/assets/images/relu_network_structure.png)
![ReLU 逼近效果](/projects/from-scratch-nn/assets/images/relu_approximation.png)
...
![MLP 前向与反向传播](/projects/from-scratch-nn/assets/images/mlp_forward_backward.svg)
...
1. 看配套实践引导：
   [03-任务二实践引导.md](/neural-networks-from-scratch/08-practice-circle-classifier/)
2. 运行和修改练习代码：
   [mission_1.py](/projects/from-scratch-nn/repo/exercises/task_01_circle_classifier/mission_1.py)
